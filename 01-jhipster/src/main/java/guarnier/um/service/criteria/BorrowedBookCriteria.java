package guarnier.um.service.criteria;
...
/**
 * Criteria class for the {@link guarnier.um.domain.BorrowedBook} entity. This class is used
 * in {@link guarnier.um.web.rest.BorrowedBookResource} to receive all the possible filtering options from
